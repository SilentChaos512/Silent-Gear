...
## [1.21.11-4.1.3] - 2026-02-19
### Added
- The material book, previously added in the recent 1.21.1 versions. It lists all available materials. The book contents are generated programmatically, so all materials from both mods and data packs will show up.

## [1.21.11-4.1.2] - 2026-02-06
### Fixed
- Swords and similar items crashing the game [#879]
- Armor receiving incorrect attribute modifiers [#877]

## [1.21.11-4.1.1] - 2026-01-23
### Added
- New traits, Polished and Oxidized, for copper (WIP, no visual effects currently)
### Changed
- Copper stats should match vanilla now
- Updated some item textures (unweeked)
