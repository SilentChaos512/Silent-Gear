    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource buffer, int packedLight, int packedOverlay) {
        ...
        for (var partInst : sortedParts) {
            ...
            for (var spriteLocation : spriteLocations) {
                var packedColor = GearColorUtils.getBlendedColorForPartInGear(stack, partInst.getType());
                if (partInst.getType() == PartTypes.MAIN.get() && GearData.hasPartOfType(stack, PartTypes.COATING.get())) {
                    packedColor = GearColorUtils.getBlendedColorForPartInGear(stack, PartTypes.COATING.get());
                }
