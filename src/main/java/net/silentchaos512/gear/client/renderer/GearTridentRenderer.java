...
public class GearTridentRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext transform, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
	       ...
	       int color_toolrod = GearColorUtils.getBlendedColorForPartInGear(stack, PartTypes.ROD.get());
	       int color_grip = GearColorUtils.getBlendedColorForPartInGear(stack, PartTypes.GRIP.get());
	       int color_spikes = GearColorUtils.getBlendedColorForPartInGear(stack, PartTypes.MAIN.get());
	       int color_tip = GearColorUtils.getBlendedColorForPartInGear(stack, PartTypes.TIP.get());
	       int color_coating = GearColorUtils.getBlendedColorForPartInGear(stack, PartTypes.COATING.get());
