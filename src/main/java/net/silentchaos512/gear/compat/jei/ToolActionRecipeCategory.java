...
public class ToolActionRecipeCategory implements IRecipeCategory<ToolActionRecipe> {
    ...
    public ToolActionRecipeCategory(IGuiHelper guiHelper) {
        ...
        localizedName = TextUtil.translate("jei", "group.tool_action");
    }
    ...
    @Override
    public void draw(ToolActionRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
