...
//            .add((IForgeRegistry.ClearCallback<ItemStat>) (owner, stage) -> STATS_IN_ORDER.clear())
    ...
    // Ranged Weapons
    public static final ItemStat RANGED_DAMAGE = new ItemStat(0f, 0f, 10000f, TextFormatting.AQUA, new ItemStat.Properties().displayFormat(ItemStat.DisplayFormat.MULTIPLIER).affectedByGrades(true).synergyApplies());
    public static final ItemStat RANGED_SPEED = new ItemStat(0f, -10f, 10f, TextFormatting.AQUA, new ItemStat.Properties().displayFormat(ItemStat.DisplayFormat.MULTIPLIER).affectedByGrades(false));
