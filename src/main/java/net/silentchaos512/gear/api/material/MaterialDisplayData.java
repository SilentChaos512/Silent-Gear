...
public record MaterialDisplayData(
        ...
        MaterialEquippableInfo equippableInfo
) {
    public static final Codec<MaterialDisplayData> CODEC = RecordCodecBuilder.create(
            instance -> instance.group(
                    ...
                    MaterialEquippableInfo.CODEC.fieldOf("equippable").forGetter(d -> d.equippableInfo)
            ).apply(instance, (name, prefix, color, textureType, armor) ->
                    new MaterialDisplayData(name, prefix.orElse(Component.empty()), color, textureType, armor)
            )
    );
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, MaterialDisplayData> STREAM_CODEC = StreamCodec.composite(
            ...
            Color.STREAM_CODEC, d -> d.color,
            TextureType.STREAM_CODEC, d -> d.mainTextureType,
            MaterialEquippableInfo.STREAM_CODEC, d -> d.equippableInfo,
