...
public record MaterialCraftingData(
        Optional<Ingredient> craftingItem,
    ...
    public static final Codec<MaterialCraftingData> CODEC = RecordCodecBuilder.create(
            instance -> instance.group(
                    Ingredient.CODEC.optionalFieldOf("ingredient").forGetter(d -> d.craftingItem),
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, MaterialCraftingData> STREAM_CODEC = StreamCodec.composite(
            Ingredient.OPTIONAL_CONTENTS_STREAM_CODEC, d -> d.craftingItem,
    ...
    public MaterialCraftingData(
        ...
        this(Optional.of(craftingItem), categories, gearTypeBlacklist, partSubstitutes, canSalvage);
    }
}
