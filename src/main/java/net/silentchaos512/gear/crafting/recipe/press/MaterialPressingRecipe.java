...
public class MaterialPressingRecipe extends PressingRecipe {
    public MaterialPressingRecipe(CommonInfo commonInfo, Ingredient ingredient, ItemStackTemplate result) {
        super(SgRecipes.PRESSING_MATERIAL.get(), commonInfo, ingredient, result);
    }
    ...
    public ItemStack assemble(SingleRecipeInput input) {
        ...
        ItemStack ret = this.result().create();
        if (material != null) {
