...
public class DataResourceManager<T> implements ResourceManagerReloadListener, Iterable<T> {
    ...
    private final Map<Identifier, String> packNameByKey = new HashMap<>();
    ...
    private T tryDecode(DynamicOps<JsonElement> ops, Identifier name, String packName, JsonObject json) {
